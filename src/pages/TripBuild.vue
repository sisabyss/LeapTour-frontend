<template>
    ...
    <div>
        ...
        <div style="display: flex;flex-direction: row; border: solid 1px black; height: 50px; width: 500px;">
            <div @click="search">
...
async function getPlanFromAI(addr) {
    ...
    try {
        const completion = await client.chat.completions.create({
            ...
            messages: [{
                role: "system",
                content: '你是一个旅游向导，熟悉世界各地的旅游景点。请你根据用户的旅游地点，帮助用户制订一个详细的旅游计划。请将整个回答放在一个JSON对象里面，首先对用户旅游地点做一个250字左右介绍，放在introduce里面，然后的请你给出三天的旅游计划，每天去三个景点，尽量每一天的景点相关且靠近放在这样的JSON格式里面：{Day_1:{attraction_1:{name:"",description:""}},Day_2:{},Day_3:{}}。'
            }, {
                role: "user",
