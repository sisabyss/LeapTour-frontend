...
<template>
  <div class="grid grid-cols-12 my-2 border border-gray-200 hover:shadow-xl h-fit">
    ...
    <div class="col-span-12 mmd:col-span-4 min-h-[180px] max-h-[230px]">
      <router-link to="">
        <img
          src="https://media-cdn.tripadvisor.com/media/photo-s/22/d9/7b/42/this-image-has-been-removed.jpg"
          alt=""
    ...
    <div class="col-span-12 mmd:col-span-8 p-3">
      <!-- {/* Name */} -->
      <router-link to="/">
        <h2 class="font-semibold md:text-lg">Chongqing University</h2>
      </router-link>
      <!-- {/* / Name */} -->
      ...
      <div class="flex flex-col-reverse mmd:grid mmd:grid-cols-12">
        ...
        >
          <!-- {/* Offer Provider Logo */} -->
          <img src="" alt="" class="h-12 m-auto object-cover hidden mmd:block" />

          <p>
            <!-- {/* Offer Price */} -->
            <span class="font-semibold text-lg mmd:text-2xl"> </span>
        ...
        <div class="col-span-3 text-center space-y-2 mmd:border-r mmd:border-dotted px-3 relative hidden mmd:block">
          ...
          <a key="1" target="_blank" href="" class="text-[11px] block group">
            ...
            <p class="font-semibold group-hover:underline">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 m-auto text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                <path
                  fillRule="evenodd"
          ...
          <div class="absolute -bottom-4/5 -left-2 z-20 hidden mmd:block">
            ...
            <div class="bg-white w-fit p-5 shadow relative space-y-2">
              <!-- {/* Maps through a List of Offers but Onlt redners 4 total with the rest hidden behind a show more state */} -->
              <a key="{i}" target="_blank" href="{offer.link}" class="text-[11px] block group relative">
                <div
